...
function MobilesScreen({ initialSub = "abonnements", onOpenDetail }) {
  const titles = { abonnements: "Abonnements mobiles", commandes: "Commandes mobile data" };
  ...
  return (
    <>
      <Toolbar>
        ...
        <Select placeholder="Forfait" options={["Mobile 50 Go","Mobile 100 Go","Mobile Illimité","Data Pro 20 Go","Data Pro 100 Go"]} width={180} icon="package" />
        <Select placeholder="Porteur réseau" options={["Orange","SFR","Bouygues","Free"]} width={160} icon="antenna" />
        <Select placeholder="Statut" options={["Actif","Suspendu","Désactivé"]} width={140} icon="circle" />
        <div className="grow" />
        <Button variant="tertiary" icon="download">Exporter</Button>
        <Button variant="primary" icon="plus">Nouvel abonnement</Button>
      </Toolbar>
      <TableBox>
