...
function subLabel(screen, sub) {
  const map = {
    ...
    referentiel:  { revendeurs: "Revendeurs", clients: "Clients", sites: "Sites", services: "Services", catalogues: "Catalogues" },
    mobiles:      { abonnements: "Abonnements", commandes: "Commandes mobile data" },
